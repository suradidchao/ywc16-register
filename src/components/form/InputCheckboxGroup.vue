      ...
      <div class="col-sm-6">
        <div class="checkbox-container">
          <label class="label-container" v-if="checkbox === 'อื่นๆ'">
            ...
            <label class="checkbox-label"><span>{{ checkbox }}</span></label>
            <input type="text" class="checkbox-input input-lg input-css" @blur="editCheckboxOther" v-model="checkboxOther" placeholder="ระบุ">
          </label>
